...
const formSchema = z.object({ name: z.string().min(1, { message: "Servrer name is required." }), imageUrl: z.string().min(1, { message: "Server image is required." }) });
...
export const EditServerModal = () => {
  ...
  const form = useForm({ resolver: zodResolver(formSchema), defaultValues: { name: "", imageUrl: "" } });
